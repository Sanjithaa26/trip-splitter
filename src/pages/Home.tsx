...
const features = [
  ...
  { title: "Debt Summary", desc: "Info on who owes whom", to: "/debts", anchor: false, gradient: "grad-4" },
  { title: "Currency Converter", desc: "Live currency exchange rates", to: "/currency", anchor: false, gradient: "grad-5" },
  ...
  { title: "Map", desc: "See trip locations on a map", to: "/map", anchor: false, gradient: "grad-4" },
  ...
  return (
    <div>
      <section className="hero">
        <h1 className="title text-balance">Plan. Split. Settle. Travel Anywhere Together.</h1>
